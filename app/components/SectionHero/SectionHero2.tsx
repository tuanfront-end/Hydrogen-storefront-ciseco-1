  ...
  const renderItem = (index: number) => {
    ...
    return (
      <div
        ...
        key={index}
      >
        <div className="absolute bottom-4 start-1/2 -translate-x-1/2 rtl:translate-x-1/2 flex justify-center">
          {DATA.map((_, index) => {
            const isActive = indexActive === index;
            return (
              <div
        ...
        <div className="absolute inset-0 bg-[#E3FFE6]">
          <Image
            data={{
              altText: 'hero',
              url: 'https://cdn.shopify.com/s/files/1/0455/2176/4502/files/hero-2-bg.png?v=1634640733',
            }}
        ...
        <div className="relative container pb-0 pt-14 sm:pt-20 lg:py-44">
          <div
            className={`relative w-full max-w-3xl space-y-8 sm:space-y-14 nc-SectionHero2Item__left`}
          >
            ...
            <ButtonPrimary
              className="nc-SectionHero2Item__button py-3 px-6 sm:py-5 sm:px-9 "
              href={item.btnLink}
            >
