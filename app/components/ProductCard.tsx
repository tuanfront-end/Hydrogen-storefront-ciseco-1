...
export type TProduct = RecommendedProductsQuery['products']['nodes'][0];
...
const ProductCard: FC<ProductCardProps> = ({className = '', data, isLiked}) => {
  ...
  const {id, priceRange, handle, images, title, description} = data;
      ...
      >
        ...
        <div className="space-y-4 px-2.5 pt-5 pb-2.5">
          ...
          <div className="flex justify-between items-end ">
            <Prices price={priceRange.minVariantPrice.amount} />
